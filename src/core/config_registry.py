...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "SECTOR_SCAN_ENABLED": {
        "title": "Sector Inflection Scan Enabled",
        "description": "Enable the ETF sector inflection point scan.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 19,
        "help_key": "settings.data_source.SECTOR_SCAN_ENABLED",
        "examples": [
            "SECTOR_SCAN_ENABLED=false",
            "SECTOR_SCAN_ENABLED=true",
        ],
    },
    "SECTOR_SCAN_BENCHMARK": {
        "title": "Sector Scan Benchmark Index",
        "description": "Benchmark index used for market regime switch (e.g., 000300).",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 19.1,
        "help_key": "settings.data_source.SECTOR_SCAN_BENCHMARK",
        "examples": [
            "SECTOR_SCAN_BENCHMARK=000300",
        ],
    },
    "SECTOR_SCAN_NOTIFY": {
        "title": "Sector Scan Notify Enabled",
        "description": "Enable sending notification alerts for sector inflection scans.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 19.2,
        "help_key": "settings.data_source.SECTOR_SCAN_NOTIFY",
        "examples": [
            "SECTOR_SCAN_NOTIFY=true",
        ],
    },
