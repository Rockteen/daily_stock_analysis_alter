...
import { BarChart3, Bell, BriefcaseBusiness, Compass, Home, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'sector', labelKey: 'layout.nav.sector', to: '/sector', icon: Compass },
